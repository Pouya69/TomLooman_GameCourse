...
#include "RogueBlackholeAttackAction.h"
...
URogueBlackholeAttackAction::URogueBlackholeAttackAction()
{
	ActionName = "Blackhole Attack";
	MuzzleSocketName = "Muzzle_01";
}

void URogueBlackholeAttackAction::StartAction_Implementation(AActor* Instigator)
{
	...
	{
		UNiagaraFunctionLibrary::SpawnSystemAttached(BlackholeCastingEffect, Character->GetMesh(), MuzzleSocketName,
	...
	{
		AttackTimerElapsed(Instigator, BlackholeProjectileClass);
	});
	GetWorld()->GetTimerManager().SetTimer(AttackTimerHandle, TimerDelegate, AttackTimer, false);
}

void URogueBlackholeAttackAction::StopAction_Implementation(AActor* Instigator)
{
